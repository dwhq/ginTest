...
type User struct {
	...
	Password        string       `gorm:"column:password;NOT NULL" json:"-"`                                               // 会员密码
	PayPass         string       `gorm:"column:pay_pass" json:"-"`                                                        // 安全密码
	...
	RunRegisterAt   sql.NullTime `gorm:"column:run_register_at" json:"run_register_at,omitempty"`                         // 执行任务时间
